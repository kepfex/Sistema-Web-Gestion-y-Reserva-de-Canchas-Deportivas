...
class AuthLoginFeatureTest extends TestCase
{
    ...
    public function test_class_exists()
    {
        ...
        self::assertTrue(class_exists(\App\Livewire\Auth\Login::class));
    }
            ...
            public function test_authenticated_user_can_mount_component()
    {
        ...
        $this->actingAs($user);
        if (class_exists('\App\Livewire\Auth\Login') && is_subclass_of('\App\Livewire\Auth\Login', \Livewire\Component::class)) {
    ...
    {
        $this->assertTrue(class_exists(\App\Livewire\Auth\Login::class));
    }

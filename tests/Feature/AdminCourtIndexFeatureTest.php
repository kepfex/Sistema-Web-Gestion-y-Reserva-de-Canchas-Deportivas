...
use App\Livewire\Admin\Court\Index;
use App\Models\User;

class AdminCourtIndexFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_guest_is_redirected_to_login_for_admin_courts()
    {
        $response = $this->get('/admin/courts');
        $response->assertRedirect('/login');
    }

    public function test_authenticated_user_is_not_redirected_to_login_for_admin_courts()
    {
        $user = User::factory()->create();
        $response = $this->actingAs($user)->get('/admin/courts');

<div>
    ...
    <div class="flex justify-between items-center mb-6 mt-4">
        ...
        <a wire:navigate href="{{ route('admin.court-types.create') }}"
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table
            ...
            <tbody>
                @forelse ($courtTypes as $courtype)
                    <tr
                        ...
                        <td class="px-6 py-3">
                            {{ $courtype->descripcion }}
                        </td>
                        <td class="px-6 py-3 text-right flex space-x-2">
                            <a wire:navigate href="{{ route('admin.court-types.edit', $courtype) }}"
                ...
                @empty
                    <tr>
                        <x-table-empty-state 
                            ...
                            :search="$search" 
                            title={{$titulo}}
                            :createUrl="route('admin.court-types.create')" />
                    </tr>
                @endforelse
            </tbody>
        </table>

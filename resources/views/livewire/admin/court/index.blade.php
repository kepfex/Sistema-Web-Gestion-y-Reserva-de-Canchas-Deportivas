<div>
    ...
    <div class="flex justify-between items-center mb-6 mt-4">
        ...
        <a wire:navigate href="{{ route('admin.courts.create') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                class="w-5 h-5 me-2 icon icon-tabler icons-tabler-outline icon-tabler-soccer-field">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">  {{-- Tabla --}}
        <table
                ...
                @forelse ($courts as $court)
                    <tr
                        ...
                        <td class="px-6 py-3 text-right flex space-x-2">
                            <a wire:navigate href="{{ route('admin.courts.edit', $court) }}"
                            ...
                            <button
                                ...
                                title: 'Eliminar Cancha Deportiva', 
